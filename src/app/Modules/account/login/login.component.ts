...
import { COMMON_VALIDATION, NAME_PATTERN, PASSWORD_MIN_LENGTH, PATTERN_SPACE, USERNAME_MAX_LENGTH } from 'src/app/constant/validation';
...
export class LoginComponent implements OnInit {
  ...
  createForm() {
    this.loginForm = this.fb.group({
      username: ['', [COMMON_VALIDATION, NAME_PATTERN , USERNAME_MAX_LENGTH]],
